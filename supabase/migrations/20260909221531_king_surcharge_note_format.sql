-- ============================================================
-- Migration: king_surcharge_note_format
-- Der Note-Text der Pumpenkönig-Zuschlag-Buchung soll immer
-- "<Strafart>-König" lauten (z.B. Strafart "Pumpen" → "Pumpen-König",
-- Strafart "Klingel" → "Klingel-König"), statt fest "Pumpenkönig: ..."
-- unabhängig vom tatsächlichen Namen der Strafart.
-- ============================================================
  ...
  loop
    ...
    loop
      ...
      values (
        ...
        v_king_rule.name || '-König', v_king_rule.id
      );
    end loop;
  end loop;
end;
